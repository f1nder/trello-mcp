...
describe("Checklist Tools", () => {
  ...
  describe("get_card_checklists", () => {
    it("should return checklists for a card", async () => {
      ...
      const result = await checklistTools.handleToolCall(
        "get_card_checklists",
        args,
        mockTrelloClient
      );

      expect(mockTrelloClient.getCardChecklists).toHaveBeenCalledWith(
        "test-card-id"
      );
    ...
    it("should handle errors when getting checklists", async () => {
      const args = { cardId: "test-card-id" };
      mockTrelloClient.getCardChecklists.mockRejectedValue(
        new Error("Not found")
      );
      const result = await checklistTools.handleToolCall(
        "get_card_checklists",
  ...
  describe("create_checklist", () => {
    it("should create a checklist", async () => {
      ...
      expect(mockTrelloClient.createChecklist).toHaveBeenCalledWith(
        "test-card-id",
        "New Checklist"
      );
    ...
    it("should handle errors when creating a checklist", async () => {
      const args = { cardId: "test-card-id", name: "New Checklist" };
      mockTrelloClient.createChecklist.mockRejectedValue(
  ...
  describe("add_checklist_item", () => {
    it("should add an item to a checklist", async () => {
      ...
      expect(mockTrelloClient.addChecklistItem).toHaveBeenCalledWith(
        "test-checklist-id",
        "New Item",
        "bottom"
      );
    ...
    it("should handle errors when adding an item", async () => {
      const args = { checklistId: "test-checklist-id", name: "New Item" };
      mockTrelloClient.addChecklistItem.mockRejectedValue(
  ...
  describe("update_checklist_item", () => {
    ...
    it("should handle errors when updating an item", async () => {
      ...
      mockTrelloClient.updateChecklistItem.mockRejectedValue(
        new Error("Could not update")
      );
      const result = await checklistTools.handleToolCall(
        "update_checklist_item",
        args,
  ...
  describe("delete_checklist", () => {
    it("should delete a checklist", async () => {
      ...
      expect(mockTrelloClient.deleteChecklist).toHaveBeenCalledWith(
        "test-checklist-id"
      );
    ...
    it("should handle errors when deleting a checklist", async () => {
      const args = { checklistId: "test-checklist-id" };
      mockTrelloClient.deleteChecklist.mockRejectedValue(
        new Error("Could not delete")
      );
      const result = await checklistTools.handleToolCall(
        "delete_checklist",
        args,
  ...
  describe("delete_checklist_item", () => {
    it("should delete a checklist item", async () => {
      const args = { checklistId: "test-checklist-id", itemId: "test-item-id" };
      ...
      expect(mockTrelloClient.deleteChecklistItem).toHaveBeenCalledWith(
        "test-checklist-id",
        "test-item-id"
      );
    ...
    it("should handle errors when deleting a checklist item", async () => {
      const args = { checklistId: "test-checklist-id", itemId: "test-item-id" };
      mockTrelloClient.deleteChecklistItem.mockRejectedValue(
        new Error("Could not delete")
      );
      const result = await checklistTools.handleToolCall(
        "delete_checklist_item",
